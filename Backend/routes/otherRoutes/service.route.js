...
} from "../../controllers/service/cardStatus.js";
import {
  cardMiddleware,
  cardStatusMiddleware,
} from "../../middlewares/cardExp.middleware.js";
...
serviceRouter
  .route("/user-details")
  .get(verifyUserMiddleware, userDetailsController);

serviceRouter
  .route("/personal-details")
  .get(verifyUserMiddleware, personalDetailsController);
...
serviceRouter
  .route("/bank-status")
  .post(blockedUserMiddleware, bankStatusController);
...
serviceRouter
  ...
  .get(verifyUserMiddleware, beneficiaryList);
...
serviceRouter
  ...
  .get(verifyUserMiddleware, allTransactionController)
  .post(verifyUserMiddleware, userSpecificTransactionController);

serviceRouter
  .route("/getCardDetails")
  .get(verifyUserMiddleware, getCardDetailsController);
